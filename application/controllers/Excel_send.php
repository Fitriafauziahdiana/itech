...
class Excel_bigdata extends CI_Controller {
	...
	public function index()
	{
	    ...
	    $excel->setActiveSheetIndex(0)->setCellValue('H6', "JENIS");
	    ...
	    $aplikasi = $this->Mod_surat->read_bigdata();
	    $no = 1; 
	    $numrow = 7; 
	    foreach($aplikasi as $row){ 
	      ...
	      $excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, $row->jeniskegiatan);
