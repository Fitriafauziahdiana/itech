								...
								foreach ($arsip as $key => $row) { ?>
									<tr>
										...
										<td width="15%" align="center">
											...
											<a href="<?php echo base_url('File1') ?>" class="btn btn-flat btn-primary btn-sm">
												<i class="fas fa-eye"></i>
											</a>

											<a href="<?php echo base_url('arsip/update/' . $row->id) ?>" title="Update">
...
<form action="<?php echo base_url('arsip/add') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
