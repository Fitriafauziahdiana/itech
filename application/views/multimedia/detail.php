	...
	<a href="<?php echo base_url('multimedia') ?>" class="btn btn-flat btn-danger btn-sm"><i class="fa fa-arrow-left "></i> Kembali</a>
		<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="box">
						<div class="box-header bg-yellow"><i class="fas fa-file-archive"></i> Detail Multimedia</div>
						<div class="box-body">
							<div class="col-md-12 text-center">
								<h4>RINCIAN DATA MULTIMEDIA</h4>
							</div>
							<div class="col-md-12" style="margin-top: 20px;">
								<form class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-md-6"><?php echo $view['namakegiatan'] ?></div>
									</div>
									<div class="form-group">
										<div class="col-md-6 text-right">Link Video</div>
										<div class="col-md-6"><?php echo $view['linkvideo'] ?></div>
									</div>
