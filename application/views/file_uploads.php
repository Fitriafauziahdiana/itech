...
<a href="<?php echo base_url('bigdata') ?>" class="btn btn-flat btn-danger btn-sm"><i class="fa fa-arrow-left "></i> Kembali</a>
	...
	<div class="row">
		<div class="col-sm-4">
			...
			<form method="POST" action="<?php echo base_url(); ?>filess/insert" enctype="multipart/form-data">
				...
				<tbody>
					...
					foreach($filess as $file){
						...
						<tr>
							...
							<td><a href="<?php echo base_url().'filess/download/'.$file->id; ?>" class="btn btn-success"title="download"><i class="fa fa-user-times"></i> Download</button>
                            <td width="10%" align="center">
							<a href="<?php echo base_url('filess/del_file/'.$file->id) ?>">
