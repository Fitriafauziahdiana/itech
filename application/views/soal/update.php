				...
				<form action="<?php echo base_url('Soal/update_soal') ?>" method="post" class="form-horizontal">
					<div class="box box-solid">
						<div class="box-body">
				        	...
				        	<div class="form-group">
				        		<label for="berkas1" class="control-label col-md-3">FIle Soal :</label>
				        		<div class="col-md-7">
				        			 <input type="text" class="form-control" name="berkas1" id="berkas1" value="<?php echo $detail['berkas1'] ?>" autocomplete="off" readonly>
				        		</div>
				        	</div>
				        	<div class="form-group">
