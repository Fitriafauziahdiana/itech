							...
							<tbody>
								<?php $no=1; foreach ($soal as $key=>$row){ ?>
									<tr>
										...
										<td align="center">
											<a href="<?php echo base_url('./media/soal/'. $row->berkas1) ?>" title="Download" class="btn btn-sm btn-warning"><i class="fas fa-cloud-download-alt "></i></a>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select name="jenis" id="jenis" class="form-control">
                        ...
                        <option value="Try Out">U S P B K</option> 
                    </select>
                </div>
            </div>
        	<div class="form-group">
        		<label for="berkas1" class="control-label col-md-3">Upload soal :</label>
        		<div class="col-md-9">
